...
class ProgressBar(Widget):
	...
	def _draw(self):
		...
		mid_x01 = self.gl_position[0][0] + (self.gl_position[1][0] - self.gl_position[0][0]) * self._percent
		mid_y01 = self.gl_position[0][1] + (self.gl_position[1][1] - self.gl_position[0][1]) * self._percent
		mid_x32 = self.gl_position[3][0] + (self.gl_position[2][0] - self.gl_position[3][0]) * self._percent
		mid_y32 = self.gl_position[3][1] + (self.gl_position[2][1] - self.gl_position[3][1]) * self._percent
