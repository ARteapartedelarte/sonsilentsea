...
import bpy
from os import path
import sssSDK.objects.floating as floating


# Module data
NAME = 'Ship'
DESCRIPION = 'Ship object is the super class of the floating one' + \
' providing a set of tools to control the ship and the subsystems.'
SELECTABLE = True
CLASS_NAME = 'sssShip'
SCRIPT_NAME = 'sss_ship'
