...
def updateValues():
    ...
    obj = bpy.context.object
    obj.game.properties['min_angle'].value = obj.sss_min_angle
    obj.game.properties['max_angle'].value = obj.sss_max_angle
    obj.game.properties['vel_angle'].value = obj.sss_vel_angle

def generateObjectProperties(update_callback):
    """Generate the Blender object properties.
    """
    bpy.types.Object.sss_min_angle = bpy.props.FloatProperty(
        default=-360.0,
        min=-360.0,
        max=0.0,
    ...
    bpy.types.Object.sss_vel_angle = bpy.props.FloatProperty(
        default=5.0,
        min=1.0,
        max=360.0,
        update=update_callback,
